...
const API_URL = 'https://lxsongapi.ikunshare.link'
const API_KEY = ''
...
const ikunApis = SUPPORT_SOURCES.reduce((apis, source) => {
  apis[`ikun_api_${source}`] = createMusicUrlApi({
    source,
